...
def multiple_field_plot(lon, lat, f, significance=None, projections=ccrs.Orthographic(central_latitude=90), extents=None, cmaps='RdBu_r', figsize=(9,6), fig_num=None, one_fig_layout=False,
